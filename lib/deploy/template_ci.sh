...
UNIT=infrastructure
NAMESPACE=suppliers-portal-eu
GITLAB_PROJECT=suppliers-portal-eu-registration
K8S_KLUSTER=$1
PROJECT_NAME=$2
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: ${PROJECT_NAME}
          image: git.wildberries.ru:4567/${UNIT}/${GITLAB_PROJECT}/${PROJECT_NAME}:${NEW_TAG}
          ports:
            - containerPort: 80
          env: []
      imagePullSecrets:
...
manifests_path: k8s
project_token: 23ed13c384454cf5a088fc4cf6d7f78c
images:
